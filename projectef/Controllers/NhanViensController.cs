...
namespace projectef.Controllers
{
    public class NhanViensController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Address,Phone")] NhanVien nhanVien)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Address,Phone")] NhanVien nhanVien)
        {
            if (id != nhanVien.Id)
            {
                return NotFound();
